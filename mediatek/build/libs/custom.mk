...
endef
define .if-cfg-qs
$(if $(filter-out QS_INHERIT_PARENT_PROJECTS_NAME,$(strip $(1))),$(2),$(3))
endef
define mtk.custom.generate-macros
$(strip $(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME),$(call .if-cfg-on,$(t),-D$(call uc,$(t))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_QS_EX),$(call .if-cfg-on,$(t),-D$(call uc,$(t))))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINED_QS_EX), -D$(call uc,$(t)))
$(foreach t,$(AUTO_ADD_GLOBAL_DEFINE_BY_NAME_VALUE_QS_EX),$(call .if-cfg-on,$(t),$(foreach v, $(call uc,$($(t))), $(call .if-cfg-qs, $(t), -D$(call uc,$(t)_$(v)), -DQS_PRJ_$(v)))))
