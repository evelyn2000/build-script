...
ifneq ($(QS_SUB_PROJECT_DWS_FILENAME), )
	$(hide) cp -f $(MTK_ROOT_CUSTOM)/$(PROJECT)/kernel/dct/dct/$(QS_SUB_PROJECT_DWS_FILENAME).dws $(MTK_ROOT_CUSTOM)/$(PROJECT)/kernel/dct/$(PRIVATE_CUSTOM_KERNEL_DCT)/codegen.dws
endif
