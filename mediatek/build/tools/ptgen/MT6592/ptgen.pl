...
sub InitGlobalValue
{
    ...
    else
    {
        ...
        my $QS_EMMC_DATA_SIZE = $ENV{QS_EMMC_DATA_SIZE};
        if($QS_EMMC_DATA_SIZE){
        	$Partition_layout_xls = "$ptgen_location/partition_table_$ArgList{PLATFORM}_${QS_EMMC_DATA_SIZE}.xls";
